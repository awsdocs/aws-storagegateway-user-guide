...
When deploying your gateway on Amazon EC2, the instance size must be at least **xlarge** for your gateway to function\. We recommend using one of the following instance types:

+ General\-purpose instance family—m3, m4 or m5 instance types\. We don't recommend using the **m4\.16xlarge** instance type\.

+ Storage\-optimized instance family—i2 or d2 instance types

+ Compute\-optimized instance family—c3, c4 or c5 instance types
