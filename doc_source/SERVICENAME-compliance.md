# Compliance Validation for AWS Storage Gateway<a name="SERVICENAME-compliance"></a>

Third\-party auditors assess the security and compliance of AWS Storage Gateway as part of multiple AWS compliance programs\. These include SOC, PCI, ISO, HIPAA, MTSC, C5, K\-ISMS, ENS High, OSPAR and HITRUST CSF\.
