...
| --- | --- | --- | --- | --- | 
|  Storage Gateway VM  |  Amazon Web Services  |  Transmission Control Protocol \(TCP\)  |  443 \(HTTPS\)  |  For communication from an Storage Gateway VM to an AWS service endpoint\. For information about service endpoints, see [Allowing Storage Gateway access through firewalls and routers](Requirements.md#allow-firewall-gateway-access)\.  | 
